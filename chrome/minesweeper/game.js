function gameClass(dimX, dimY, minesNumber)
{
  ...
  this.boom = undefined;
  this.boomX = undefined;
  this.boomY = undefined;
  this.openedNumber = undefined;
  this.markedNumber = undefined;
  ...
  this.undo = function()
  {
    if(this.boom == true)
    {
      this.fields[this.boomX][this.boomY].flag = this.FlagClose;
      this.playable = true;
      this.boom = false;
      this.boomX = undefined;
      this.boomY = undefined;
  ...
  this.open = function(x, y)
  {
    if(this.playable == true)
    {
      ...
      if(this.fields[x][y].flag == this.FlagOpen)
        this.openHint(x, y);
      else if(this.fields[x][y].flag != this.FlagMark)
      {
        if(this.fields[x][y].value == this.ValueBomb)
        {
        ...
        else
        {
          ...
          {
            this.playable = false;
            this.markedNumber = this.minesNumber;
          }
        }
      }
    }
  ...
  this.getOpenedNumber = function()
  {
    return this.openedNumber;
  };

  this.getMarkedNumber = function()
  {
